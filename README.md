...
**-add** Limit Add moves per game (default 8) 0 means no limit<br/>
**-rnd** RaNDomization (default 100) 0 - mean choose best move 100 - mean choose random move 200 - mean choose worst move<br/>
